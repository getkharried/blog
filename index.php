    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                <i class="fas fa-user-circle fa-white fa-2x nav-link nav-item dropdown" href="#" id="profile" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
        ...
        <div class="row" id="album" style="padding-top: 40px">
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="card-title">Un post</div>
                        <div class="card-text">Example aaaa aaa</div>
                        <hr>
